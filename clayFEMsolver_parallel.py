...
class Omega:
    ...
    def initialize_solid(self, Sx, Sy, d, R, loc, sigma_value, read):
        """
        ...
        if read:
            ...
            self.solid = np.load('solid.npy')
            self.surf  = np.load('surf.npy')
...
omega.initialize_solid(Sx=40, Sy=40, d=2, R=100, loc=[30,30,30], sigma_value=0.1, read=True)
